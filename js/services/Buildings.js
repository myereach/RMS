...
angular.module("rmsApp.services")
    .factory('Buildings', function(Restangular) {
        ...
        /*service.getById = function (id) {
            ...
            //return  service.one(id).get(id).$object;
            return service.one(id).get().then(function(it){
                //console.log("service.getById "+JSON.stringify(it));
                return  it;
            });
        };*/
        service.getById = function (id) {
